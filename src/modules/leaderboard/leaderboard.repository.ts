...
const isDescendingLevel = (levelId: number) => levelId === 101
...
export async function submitRecord(
  ...
  const betterScoreCondition = isDescendingLevel(levelId)
      ? sql`EXCLUDED.score > records.score`
      : sql`EXCLUDED.score < records.score`
